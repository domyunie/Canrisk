...
<body>
    ...
    <div class="detalle-wrapper">
        <a href="Contacto.php" class="detalle-volver">&larr; Volver a la pagina de contactos</a>
    ...
    <div class="footer-container">
        <div class="footer-content">
            ...
            <div class="footer-col">
                ...
                <ul class="Advice_1">
                    <li>Esta pagina NO reemplaza la ayuda de un profesional medico.</li>
                    <li>En caso de tener algun tipo de emergencia o un sintoma puede</li>
                    <li>apoyarse en los diferentes números de hospitales que nosotros</li>
        ...
        if (hospital) {
            contenedor.innerHTML = `
                ...
                <div class="detalle-info">
                    ...
                    <a href="tel:${hospital.telefono}"><strong>Telefono:</strong> ${hospital.telefono}</a>
                    <p><strong>Ubicación:</strong> ${hospital.ubicacion}</p>
                    <p><strong>Horario:</strong> ${hospital.horario}</p>
                    <p><strong>Descripción:</strong> ${hospital.descripcion}</p>
                    ...
                    <p><strong>Calificación:</strong> ${hospital.calificacion} / 5</p>
                </div>
            `;
        } else {
            contenedor.innerHTML = `<p>No se encontró la información de este hospital.</p>`;
        }
    </script>
